  ...
  return (
    <div className="flex flex-col justify-center items-center gap-4">
      ...
      <div className="btn">
          ...
          <button title="Sign up"  className=' border-2 cursor-pointer rounded-lg  flex flex-row items-center justify-center lg:py-3 py-2 lg:px-4 px-3 lg:w-40 bg-white text-black dark:bg-black dark:text-white' aria-label="Signup" type="submit">
            Create account
          </button>
        </div>
    </div>
